...
const xtime = moment.tz('Asia/Kolkata').format('HH:mm:ss')
        ...
        const time2 = moment().tz('Asia/Kolkata').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var xeonytimewisher = `Hey am BIG DADDY 👑 created by ᴘʜ✦ꜱᴛᴀʀ. You are still awake 😯, Night owl alert! Time to cozy up and catch some Z's. Goodnight 🌃`
 }
 if(time2 < "19:00:00"){
var xeonytimewisher = `Hey am BIG DADDY 👑 created by ᴘʜ✦ꜱᴛᴀʀ. Almost time to wrap up the day! Relax, take a load off, and enjoy your evening. Anyways Good evening 🌆`
 }
 if(time2 < "18:00:00"){
var xeonytimewisher = `Hey am BIG DADDY 👑 created by ᴘʜ✦ꜱᴛᴀʀ. Almost time to wrap up the day! Relax, take a load off, and enjoy your evening. Anyways Good evening 🌆`
 }
 if(time2 < "15:00:00"){
var xeonytimewisher = `Hey am BIG DADDY 👑 created by ᴘʜ✦ꜱᴛᴀʀ. Good afternoon 🌇 It's scorching hot, i need some shade ASAP!`
 }
 if(time2 < "11:00:00"){
var xeonytimewisher = `Good Morning 🌄`
 }
 if(time2 < "05:00:00"){
var xeonytimewisher = `Hey am BIG DADDY 👑 created by ᴘʜ✦ꜱᴛᴀʀ. Morning, shaaa! Hope you slept like a king/queen ☺️`
 } 
...
await replygcxeon(`In process....`)
            ...
            sendMessageWithMentions(
    "Successfully Sent Bug To @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* ✅\n\nPause for 2mins so that BIG DADDY doesn't get your account banned✅. BUG sent useing DEADPOOL 😈",
    [whatsappNumber]
  );
            }
...
case 'lockotp': case 'tempban': {
  ...
  sendMessageWithMentions(
    ...
    " Using *" + command + "* ✅\n\nPause for 2mins so that BIG DADDY doesn't get your account banned✅.", 
    [xeonMention]
  );
  try {
...
║╔══╝─║╔═╗║─║╔╗╔╗║
║╚══╗─║║─║║─║║║║╔╝
╚═══╝─╚╝─╚╝─╚╝╚╝    *BIG DADDY* - *King of Bug's 👑🛡️💀* 
 *ANTI BUG* *version*
╰━━━━━━━━━━━━━━━━━━━━━━━━━╯
*USING DEADPOOL BUG*⚡💥
┃❁️ _ᴄʀᴇᴀᴛᴏʀ:_ ᴘʜ✦ꜱᴛᴀʀ ᴛᴇᴄʜ 🦸
┃❁️ _ᴠᴇʀꜱɪᴏɴ:_ 0.0.0 🧪
